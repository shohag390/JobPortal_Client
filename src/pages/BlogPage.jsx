      ...
      <div className="blog-hero px-5 md:px-12 lg:px-20 2xl:px-60 py-8 md:py-10 lg:py-12 2xl:py-18 flex flex-col lg:flex-row justify-between items-center gap-10 md:gap-15 lg:gap-16">
        ...
        <div className="w-full lg:w-[40%]">
          <div className="p-6 w-full bg-[#0f172a] rounded-2xl">
            <h2 className="text-[14px] md:text-[17px] lg:text-[18px] font-medium uppercase text-[#ffffffa2]">
              Latest drop
            </h2>
            <h2 className="text-[#ffff] text-[22px] md:text-[25px] lg:text-[28px] leading-7 md:leading-8 lg:leading-9 py-2 lg:py-3">
              The 90 day culture reset: rituals that stick with hybrid teams
            </h2>
            <div className="flex items-center gap-4 md:gap-5 lg:gap-6">
              <p className="flex items-center gap-1 lg:gap-2 text-[14px] md:text-[16px] text-[#ffffffa2]">
                <FaRegClock />
